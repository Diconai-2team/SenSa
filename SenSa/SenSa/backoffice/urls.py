...
urlpatterns = [
    ...
    # ═══════════════════════════════════════════════════════
    # v7 — 평면도 이미지 관리 (지도 페이지네이션 백오피스)
    # ═══════════════════════════════════════════════════════
    path('maps/images/',                       views.map_image_list,              name='map-image-list'),
    path('api/maps/images/create/',            views.map_image_create_api,        name='api-map-image-create'),
